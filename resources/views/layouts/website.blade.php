...
<html lang="en">
    ...
    <link href="{{ asset('website')}}/css/colors.css" rel="stylesheet">

    <!-- Version Tech CSS for this template -->
    <link href="{{ asset('website')}}/css/version/tech.css" rel="stylesheet">
                    ...
                    <div class="col-lg-7">
                        <div class="widget">
                            <div class="footer-text text-left">
                                <a href="index.html"><img src="{{ asset('website')}}/images/version/tech-footer-logo.png" alt="" class="img-fluid"></a>
